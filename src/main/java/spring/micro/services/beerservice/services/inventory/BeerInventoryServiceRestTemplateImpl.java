...
import spring.micro.services.beerservice.services.inventory.model.BeerInventoryDto;
...
@Component
@ConfigurationProperties(prefix = "brewery.service", ignoreUnknownFields = false)
@Slf4j
